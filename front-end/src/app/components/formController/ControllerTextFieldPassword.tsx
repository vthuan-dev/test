...
import { Box, FormHelperText, TextField, type SxProps, type Theme } from '@mui/material';
import { type Control, Controller, type FieldValues, type Path, useWatch } from 'react-hook-form';
...
function ControllerTextFieldPassword<TFieldValues extends FieldValues = FieldValues>(
   ...
   const { name, placeholder, sx, control, ...resProps } = props;
                     ...
                     <React.Fragment>
                        <Box sx={{ position: 'relative' }}>
                           ...
                           {useWatch({ control })[name] && (
                              <Box
                                 sx={{
                                    width: isShowPassword ? 24 : 24,
                                    height: isShowPassword ? 24 : 24,
                                    position: 'absolute',
                                    top: '50%',
                                    right: 0,
...
export { ControllerTextFieldPassword };
